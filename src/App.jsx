          ...
          <form>
            <div className="grid gap-y-4">
              <div>
                ...
                <input type="email" id="email" name="email" required className="w-full px-4 py-2.5 sm:py-3 rounded-lg border border-gray-200 dark:border-neutral-300 bg-white dark:bg-neutral-100 text-gray-800 dark:text-neutral-900 placeholder-gray-400 dark:placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-300" />
              </div>
              ...
              <button
                type="submit" onClick={() => navigate("/home")} className="w-full py-3 px-4 rounded-lg bg-gray-800 dark:bg-white text-white dark:text-gray-800 font-medium hover:bg-purple-600 dark:hover:bg-purple-300 focus:outline-none transition-colors"
                >
                Entrar
              </button>
            </div>
